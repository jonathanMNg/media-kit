...
///
/// {@endtemplate}
class LazyMedia extends Playable {
  ...
  /// 3. Revoke the object URL created by [LazyMedia.memory] on web.
  static final Finalizer<_LazyMediaFinalizerContext> _finalizer =
      Finalizer<_LazyMediaFinalizerContext>((context) async {
    ...
    // LazyMedia.memory : Revoke the object URL.
    try {
      if (memory) {
